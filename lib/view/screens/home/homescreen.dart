                    ...
                    child: Container(
                      ...
                      child: !projectController.projects.isNotEmpty
                          ? Center(
                              ...
                              width: Get.width * 0.5,
                              child: Text(
                                "No projects yet Tap the add button to start creating",
                          ...
                          : Row(
                              children: projectController.projects
                                  .asMap()
                                  .entries
                                  .map((MapEntry project) => GestureDetector(
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                        ...
                                        child: Padding(
                                          ...
                                          child: ProjectExpandedWidgetCard(
                                            ...
                                            subtitle:
                                                "UI Design Kit Project - ${DateFormat('MMM d, yyyy').format(DateTime.parse(project.value.createdAt ?? "2024-02-29T00:00:00.000"))}",
                                            progressLabel: "30%",
                                            progressValue: 0.3,
                                            width: Get.width * 0.9,
                                            expanded: true,
